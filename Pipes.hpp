...
Pipes::Pipes(sf::Texture & texture, float speed)
{
    ...
    upperPipe.setPosition( 300 , randomY);
    lowerPipe.setPosition(300 , randomY + pipeDifference );
    ...
    lowerPipe2.setPosition(500 , randomY + pipeDifference );
    upperPipe2.setPosition( 500 , randomY);
